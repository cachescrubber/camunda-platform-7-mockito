...
import org.operaton.community.mockito.delegate.DelegateCaseExecutionFake;
import org.operaton.community.mockito.delegate.DelegateCaseVariableInstanceFake;
import org.operaton.community.mockito.delegate.DelegateExecutionFake;
import org.operaton.community.mockito.delegate.DelegateTaskFake;
import org.operaton.community.mockito.delegate.VariableScopeFake;
import org.operaton.community.mockito.function.NameForType;
import org.operaton.community.mockito.mock.FluentExecutionListenerMock;
import org.operaton.community.mockito.mock.FluentJavaDelegateMock;
import org.operaton.community.mockito.mock.FluentTaskListenerMock;
import org.operaton.community.mockito.process.CallActivityMock;
...
import org.operaton.community.mockito.service.RuntimeServiceFluentMock;
import org.operaton.community.mockito.verify.MockitoVerification;
...
import static org.operaton.community.mockito.function.NameForType.juelNameFor;
...
public enum CamundaMockito {
   ...
   * @see org.operaton.community.mockito.Expressions#registerInstance(String,
   * Object)
   */
   ...
   * @see org.operaton.community.mockito.Expressions#getRegistered(String)
   */
   ...
   * @see #verifyJavaDelegateMock(org.operaton.community.mockito.mock.FluentJavaDelegateMock)
   */
  ...
  /**
   * Registers mocks via
   * {@link org.operaton.bpm.engine.test.mock.Mocks#register(String, Object)} for
  ...
  /**
   * Delegates to
   * {@link org.operaton.bpm.engine.test.mock.Mocks#register(String, Object)}
   *
  ...
  /**
   * @see org.operaton.bpm.engine.test.mock.Mocks#reset()
   */
