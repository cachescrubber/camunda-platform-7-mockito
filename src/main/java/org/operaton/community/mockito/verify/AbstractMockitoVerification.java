...
public abstract class AbstractMockitoVerification<M, P> implements MockitoVerification<P> {
   ...
   *          {@link org.operaton.bpm.engine.delegate.JavaDelegate},
   *          {@link org.operaton.bpm.engine.delegate.TaskListener} or
   *          {@link org.operaton.bpm.engine.delegate.ExecutionListener}.
   * @param parameterType
   *          the parameter the main method (execute() or notify() expects, one
   *          of either
   *          {@link org.operaton.bpm.engine.delegate.DelegateExecution} or
   *          {@link org.operaton.bpm.engine.delegate.DelegateTask}.
   */
