...
import static org.operaton.community.mockito.function.CreateInstance.mockInstance;
import static org.operaton.community.mockito.function.CreateInstance.newInstanceByDefaultConstructor;
 ...
 * {@link org.operaton.bpm.engine.test.mock.Mocks#register(String, Object)} and
 * {@link org.operaton.bpm.engine.test.mock.Mocks#get(Object)} in a type-safe
 * way.
 * <p/>
